...
TEST_F(CiderFilterRandomTestNG, betweenAnd) {
  ...
  assertQueryArrowIgnoreOrder("SELECT col_1 FROM test WHERE col_1 >= 5");

  assertQueryArrowIgnoreOrder("SELECT col_1, col_2 FROM test WHERE col_1 >= 0");
  assertQueryArrowIgnoreOrder("SELECT * FROM test WHERE col_1 >= 0");
  assertQueryArrowIgnoreOrder("SELECT * FROM test WHERE col_1 >= 0 AND col_1 <= 1000 ");
